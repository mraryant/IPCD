...
const Benifits = () => {
    ...
    return (
        <>
            <div id="benifits-main" className='    relative  bg-[#060606] flex flex-col items-center  md:px-20 md:py-10 px-5  min-h-[100vh] w-[100vw]     '>

              


            </div>
            {/* <div id="benifit-container" className=' w-[90%] relative flex  flex-col items-center  ' >
                    <motion.div
                        initial={{ scale: 1.2 }}
                        ...
                        <video className="    scale-[2] max-[834px]:scale-[1.1] " autoPlay muted loop src={require('../../public/assets/whayCvid.mp4')} />
                    </motion.div>


                    <div id="benifits-left" className='h-[100%] w-[100%]  '>
                        <div className='flex flex-col  gap-20     justify-between my-[40vh] max-[836px]:gap-[10vh] '>
                            ...
                            <div id='side-left' className='flex w-[33%] flex-col gap-2 z-[1] max-[836px]:w-[90%] ' >
                                <div className='flex flex-col'>
                                    ...
                                    <h2 className='  oxanium'> <span className='text-[var(--prime-yellow)]' >Corporate</span>   / Institute </h2>
                                </div>
                    ...
                    <div className='z-[1]'>
                        <div id='side-left' className='flex w-[100%]  flex-col gap-5 z-[1] max-[836px]:w-[90%] ' >
                            <div className='flex flex-col'>
                        ...
                        <div id='side-right' className='flex  flex-col gap-0 mt-20 ' >
                            ...
                            <div className='flex flex-col gap-1  text-right   z-[1] '>
