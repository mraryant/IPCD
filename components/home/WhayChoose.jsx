...
const WhayChoose = () => {
    return (
        <>
            <div id="whayC-main" className='min-h-[100vh] bg-[#060606] w-[100vw] flex flex-col justify-center items-center gap-[6vmax]    md:px-[5vmax] md:py-20 max-[834px]:py-10'>
                ...
                <div id="whayC-container" className='min-h-[80vh] flex gap-[2vmax] px-10 max-[834px]:flex-col'>
                    <div id="whayC-cont-left" className='w-[33%] flex flex-col justify-between items-center gap-[10vmax] max-[834px]:flex-row  max-[834px]:w-[100%] max-[834px]:gap-[7vw] max-[834px]:items-start max-[576px]:flex-col max-[576px]:items-center'>
                        <div className='flex flex-col gap-3 w-[90%] max-[576px]:w-[100%]  '>
                    ...
                    <div id="whayC-cont-mid" className='w-[30%] overflow-hidden flex max-[834px]:w-[100%] '>
